...
class Follower(object):
    def __init__(self, motorManager, sensor, pidController, followDistance=300, searchDistance=700, turnSpeed=25):
    ...
    def getDistDifference(self):
        return self.sensor.distanceUSEV3() - self.sensorleft.distanceUSEV3()
    ...
    def step(self):
        ...
        if self.moveState == 1:
            ...
            if self.sensor.distanceUSEV3() > self.searchDistance:
                ...
                self.manager.stopAll()
                return
            self.manager.driveStraight(self.controller.step(lastSensorReading), 1)
